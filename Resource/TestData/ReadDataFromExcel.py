...
wk = openpyxl.load_workbook('C:/Users/abhishek.jayalal/Desktop/Wakanda_automation/Resource/TestData/Testdata.xlsx')
sh = wk["Sheet1"]
print(sh.max_row)
cell = sh.cell(1, 1)
print(cell.value)
...
def getData(Data,Tag):
    ...
    #print(type(dataSet[Tag][0]))

    if type(dataSet[Tag][0])!=str:
        dataSet[Tag] = dataSet[Tag].astype(np.int64)
...
Data=fetch_from_ExcelData("C:/Users/abhishek.jayalal/Desktop/NMS_AUTOMATION/Resource/TestData/CRMTestdata.xlsx",'SERVICE','TC_001','TD_01')
value=getData(Data,'ServiceID')
print(value)
