...
TEST CASE 001
    ...
    ${AddresUpdateInfo}=  Fetch From Excel  ${CRM_TestData}  AddressUpdate  TC_002  TD_02



    Search By ProfileId  ${UserInfo}
    Manage tab  ${ProfileDetailsPage}[ManageProfile]
    Edit Profile Details
    Manage Profile Residential Address  ${AddresUpdateInfo}
    Manage Profile Permanent Address  ${AddresUpdateInfo}
    Go Back to Home Page
    #Search By ProfileId  ${UserInfo}
    #Manage tab  ${ProfileDetailsPage}[ManageProfile]
    #View Identification Details
    #Go Back to Home Page
    #Search By AccountId  ${UserInfo}
    #Edit Account Details
    #Manage tab  ${AccoutDetailPage}[ManageAccount]
    #Manage Account Address  ${AddresUpdateInfo}
    #Go Back to Home Page
